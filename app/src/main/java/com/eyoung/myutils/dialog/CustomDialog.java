...
/**
 * Author: created by ghappy on 2018/10/12 16:43
 * <p>
 * Description: 通用对话框
 *
 */
public class CustomDialog extends Dialog {
    ...
    private CustomController mAlert;

    public CustomDialog(Context context, int themeResId) {
        super(context, themeResId);
        mAlert = new CustomController(this, getWindow());
    }
    ...
    public static class Builder {
        ...
        private final CustomController.AlertParams P;
        ...
        public Builder(Context context, int themeResId) {
            P = new CustomController.AlertParams(context, themeResId);
        }
